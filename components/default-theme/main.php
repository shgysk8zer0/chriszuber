...
?>
<main role="main" itemprop="mainContentofPage" itemscope itemtype="http://schema.org/WebPageElement" id="main" <?=($login->logged_in and $login->role === 'admin') ? ' contextmenu="admin_menu"' : ''?>>
	<?php
		if (isset($missing)) {
