...
<div data-error="%STATUS%">
	...
	<ul>
		...
		<li>If you believe that I made an error, you may <a href="https://github.com/shgysk8zer0/chriszuber/issues/new" title="File a bug report">file a bug report</a></li><br />
		<li>You could try searching for what you're looking for <label for="tags_input" role="button" data-icon="L" title="Search Tags"></label></li><br />
		<li>Otherwise, just carry on as usual. Maybe you spelled something wrong, or maybe you followed a bad link.</li>
	</ul>
	<a href="%HOME%" title="Home"><img src="%HOME%super-user.svgz" alt="Logo"/></a>
	<hr /><br />
