!function () {
    ...
    !function () {
        ...
        d = c = b = function (a) {
            ...
            if (f[a] = {
            }, !e[a]) throw new Error('Could not find module ' + a);
            for (var g, h = e[a], i = h.deps, j = h.callback, k = [
            ], l = 0, m = i.length; m > l; l++) 'exports' === i[l] ? k.push(g = {
            })  : k.push(b(c(i[l])));
    ...
    a('promise/asap', [
        ...
        g = 'undefined' != typeof process && '[object process]' === {
    ...
    a('promise/race', [
        ...
        function c(a) {
            ...
            return new b(function (b, c) {
                for (var d, e = 0; e < a.length; e++) d = a[e],
